# VideoTileKun-desktop - ユーザーガイド（デスクトップ版）
...
VideoTileKun-desktop は **プレーヤーウィンドウ** と **ライブラリ（ブラウザ）ウィンドウ** の2つで構成されています。
...
- **タイルデータのクリーンアップ**: ライブラリ内の全 VideoTileKun-desktop データ（サムネイルフォルダ・タグ）を削除（取り消し不可）
